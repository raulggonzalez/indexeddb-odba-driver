 ...
 * @property {Boolean} autoIncrement      Auto increment?
 *
...
IndexedDBTable.prototype.query = function query() {
  return new IndexedDBQuery(this);
};
 ...
 *
 * @returns {Query} If the call doesn't pass a callback, it returns a Query; otherwise,
 *                  asynchronous call.
 */
