...
Object.defineProperty(odba, "ResultFilter", {value: ResultFilter});
delete ResultFilter;
 ...
 * @returns {Object[]}
 */
odba.ResultFilter.prototype.find = function find(result, filter) {
  var filtered = [];
 ...
 * @returns {Boolean}
 */
odba.ResultFilter.prototype.check = function check(row, filter) {
 ...
 * @returns {Boolean}
 */
odba.ResultFilter.prototype.checkProp = function checkProp(row, prop, filter) {
  var res;
 ...
 * @returns {Boolean}
 */
odba.ResultFilter.prototype.checkOp = function checkOp(row, prop, op, filter) {
  var res;
 ...
 * @returns {Boolean}
 */
odba.ResultFilter.prototype.$eq = function $eq(row, prop, value) {
 ...
 * @returns {Boolean}
 */
odba.ResultFilter.prototype.$ne = function $ne(row, prop, value) {
  if (value === undefined) return (row[prop] !== undefined);
  else if (value === null) return (row[prop] !== null);
  else return (row[prop] != value);
};
 ...
 * @returns {Boolean}
 */
odba.ResultFilter.prototype.$lt = function $lt(row, prop, value) {
 ...
 * @returns {Boolean}
 */
odba.ResultFilter.prototype.$le = function $le(row, prop, value) {
  if (value === undefined || value === null) return false;
  else return (row[prop] <= value);
};
 ...
 * @returns {Boolean}
 */
odba.ResultFilter.prototype.$gt = function $gt(row, prop, value) {
  if (value === undefined || value === null) return false;
  else return (row[prop] > value);
};
 ...
 * @returns {Boolean}
 */
odba.ResultFilter.prototype.$ge = function $ge(row, prop, value) {
  if (value === undefined || value === null) return false;
  else return (row[prop] >= value);
};
 ...
 * @returns {Boolean}
 */
odba.ResultFilter.prototype.$like = function $like(row, prop, value) {
 ...
 * @returns {Boolean}
 */
odba.ResultFilter.prototype.$notLike = function $notLike(row, prop, value) {
 ...
 * @retuns {Boolean}
 */
odba.ResultFilter.prototype.$in = function $in(row, prop, value) {
  if (value === undefined || value === null) return false;
 ...
 * @returns {Boolean}
 */
odba.ResultFilter.prototype.$notIn = function $notIn(row, prop, value) {
